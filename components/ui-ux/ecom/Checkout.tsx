...
const Checkout = () => {
  ...
  const taxes = 23.68;
  const shipping = 22;
  const total = subtotal + taxes + shipping - discount.amount;
    ...
    <>
      <main className="lg:flex lg:min-h-full lg:flex-row-reverse lg:overflow-hidden">
                        ...
                        <div className="flex flex-col justify-between space-y-4">
                          <div className="space-y-1 text-sm font-medium">
                            ...
                            <p className="text-gray-500">
                              {product.productDetails.breadcrumbs[0].name}
                            </p>
                            <p className="text-gray-500">
        ...
        <section
          ...
          className="hidden w-full max-w-md flex-col bg-gray-100 lg:flex"
        >
          ...
          <div className="sticky bottom-0 flex-none border-t border-gray-200 bg-gray-100 p-6">
            <form>
              <label
